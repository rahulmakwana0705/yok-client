...
const dataa = {
  ...
  gallery: [
    {
      id: 1,
      thumbnail: "https://m.media-amazon.com/images/I/61ckXdPNKTL._SY741_.jpg",
      original: "https://m.media-amazon.com/images/I/61ckXdPNKTL._SY741_.jpg",
    },
    {
      id: 2,
      thumbnail: "https://m.media-amazon.com/images/I/61wrWvif-vL._SY741_.jpg",
      original: "https://m.media-amazon.com/images/I/61wrWvif-vL._SY741_.jpg",
    },
    //   {
    // 	"id": 3,
              ...
              <SwiperSlide>
                <div className="col-span-1 transition duration-150 ease-in hover:opacity-90">
                  {checkBoxValue === "front" ? (
                    <img
                      src={
                        data?.gallery && data?.gallery[0]?.original
                    ...
                    <img
                      src={
                        data?.gallery && data?.gallery[1]?.original
          ...
          <div className="col-span-5 pt-8 lg:pt-0">
            ...
            <div>
              <h3
                ...
                className="mt-5 cursor-pointer font-black text-base md:text-lg text-heading font-semibold mb-2.5 capitalize"
              >
                Create Your Style: Design Your Own Unique T-Shirt!
              </h3>
              {customizeTshirt && (
                      ...
                      <div className="mr-10">
                        ...
                        <div className="flex">
                          <div className="relative flex items-center mr-10 ">
                            <CheckBox
                              labelKey="Front"
                              onChange={() => handleCheckBoxChage("front")}
                            />
                          </div>
                          <div className="relative flex items-center ">
                            <CheckBox
                              labelKey="Back"
                              onChange={() => handleCheckBoxChage("back")}
                            />
                          </div>
                        </div>
                      </div>
